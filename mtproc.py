...
def makeprocpath(project_path):
    ...
    Returns
    -------
    sites : It is a list of all sites in the folder.
    selectedsite : It is a string value which is the name of selected MT site.
    measid : It is a python dictionary containing float values which are the
        generated measurement IDs for all measurements in the selected site. It is
        required for the EDI file creation.
    all_meas : It is a list of all measurements in the selected MT site.
    select_meas : It is an integer value that is the serial number of the selected
        measurement.
...
def bandavg(ts,procinfo,config):
    ...
    Zxx_num = (HyHyc * ExHxc) - (HyHxc * ExHyc)
    Zxy_num = (HxHxc * ExHyc) - (HxHyc * ExHxc)
...
def targetfreq(fs):
    ...
    # JF
        ...
        ftlist = (7.01387158203311E+0000, 5.23091066021279E+0000, 3.90118724232419E+0000,
                  ...
                  2.07678587625385E-0001,1.54885661250254E-0001)
    elif fs == 16:
        ...
        ftlist = (1.61828598580477E+0000, 1.20690966685269E+0000, 9.00107247247826E-0001,
                  ...
                  4.79169519964988E-0002, 3.57362252889629E-0002)
    elif fs == 4:
        ftlist = (3.73381448636813E-0001, 2.78466033652964E-0001, 2.07678587625385E-0001,
                  ...
                  1.10557102438331E-0002, 8.24529389999566E-0003)
    elif fs == 2:
        ftlist = (3.73381448636813E-0001, 2.78466033652964E-0001, 2.07678587625385E-0001,
                  1.54885661250254E-0001, 1.15512958438456E-0001, 8.61489918401509E-0002,
                  6.42494910995510E-0002, 4.79169519964988E-0002, 3.57362252889629E-0002,
    ...
    #               7.89154580281698E-0004)
        ...
        ftlist = (1.10557102438331E-0002, 8.24529389999566E-0003, 6.14929932115646E-0003,
                  4.58611695347757E-0003, 3.42030329189097E-0003, 2.55084524166997E-0003,
                  1.90240773745913E-0003, 1.41880626092981E-0003, 1.05813867680238E-0003,
                  7.89154580281698E-0004, 5.88547574370430E-0004, 4.38935863710846E-0004,
                  3.27356191481513E-0004, 2.44140625000000E-0004)
    elif fs == 0.03125:
        ftlist = (3.42030329189097E-0003, 2.55084524166997E-0003, 1.90240773745913E-0003, 
                  1.41880626092981E-0003, 1.05813867680238E-0003, 7.89154580281698E-0004, 
                  5.88547574370430E-0004, 4.38935863710846E-0004, 3.27356191481513E-0004,
                  2.44140625000000E-0004, 2.21221629107045E-0004, 1.69779424635856E-0004,
                  1.19377664171444E-0004, 0.58780160722749E-0004)
    elif fs == 0.015625:
